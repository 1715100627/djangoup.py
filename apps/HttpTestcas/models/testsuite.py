...
class Testsuite(BaseModel):
    ...
    project = models.ForeignKey(to='Projects', on_delete=models.SET_NULL, null=True,
                                blank=True,
    ...
    status = models.CharField(max_length=12, null=False, blank=False, default='INITIAL', choices=status_choice,
                              verbose_name='是否测试通过')
    testcases = models.ManyToManyField(to='Testcases', related_name='testsuite',
                                       through='Testsuite2Testcase', through_fields=("testsuite", "testcase"),
                                       verbose_name='测试用例')
