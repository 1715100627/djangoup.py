...
class Projects(BaseModel):
    ...
    default_envs = models.ForeignKey(to='Envs', related_name='+', on_delete=models.SET_NULL, null=True,
                                     blank=True, verbose_name='默认测试环境')
    envs = models.ManyToManyField(to='Envs', related_name='project', verbose_name='环境')
